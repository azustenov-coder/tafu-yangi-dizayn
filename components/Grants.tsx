            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-24 px-4">
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tight">Grant sohiblari galereyasi</h2>
                            <p className="text-slate-400 text-sm font-bold mt-1 uppercase tracking-widest">Muvaffaqiyatli talabalarimiz</p>
                        </div>
                    ...
                    <div className="relative w-full overflow-hidden rounded-[3rem] shadow-[0_30px_60px_rgba(0,0,0,0.12)] bg-white aspect-[21/9] border border-white/20">
                        <div className="animate-slide-pause h-full">
                            {[
                                '/zakovat/awards.png',
                                '/culture/events.png',
                                '/zakovat/teamwork.png',
                                '/culture/hero.png'
                            ].map((img, i) => (
                                <div key={i} className="min-w-full h-full flex-shrink-0 relative group">
                                    <img src={img} className="w-full h-full object-cover grayscale-[20%] group-hover:grayscale-0 transition-all duration-700" alt={`Scholarship Winner ${i+1}`} />
                                    <div className="absolute inset-0 bg-gradient-to-t from-blue-900/60 via-transparent to-transparent"></div>
                                    <div className="absolute bottom-10 left-10 md:bottom-16 md:left-16 text-white max-w-lg">
                                        <div className="bg-blue-600 inline-block px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-[0.2em] mb-4">Grant G'olibi</div>
                                        <h3 className="text-3xl md:text-5xl font-black uppercase tracking-tight mb-2 drop-shadow-lg">
                                            {i === 0 ? "Akademik yutuqlar" : i === 1 ? "Iste'dodli yoshlar" : i === 2 ? "Ilmiy tadqiqotlar" : "Xalqaro e'tirof"}
                                        </h3>
                                        <p className="text-white/80 font-medium italic text-lg drop-shadow-md hidden md:block">
                                            "TAFU grantlari yoshlarga o'z bilimini namoyon etish va kelajakka ishonch bilan qarash imkonini beradi."
                                        </p>
                                    </div>
                                </div>
                            ))}
